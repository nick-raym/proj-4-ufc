...
Revision ID: 36fd9dcb6fae
Revises: 
Create Date: 2024-03-20 18:34:56.934576
...
def upgrade():
    ...
    op.create_table('fighter_match_table',
    sa.Column('match_id', sa.Integer(), nullable=False),
    sa.Column('fighter_id', sa.Integer(), nullable=False),
    sa.ForeignKeyConstraint(['fighter_id'], ['fighter_table.id'], name=op.f('fk_fighter_match_table_fighter_id_fighter_table')),
    sa.ForeignKeyConstraint(['match_id'], ['match_table.id'], name=op.f('fk_fighter_match_table_match_id_match_table')),
    sa.PrimaryKeyConstraint('match_id', 'fighter_id', name=op.f('pk_fighter_match_table'))
    )
...
def downgrade():
    # ### commands auto generated by Alembic - please adjust! ###
    op.drop_table('fighter_match_table')
